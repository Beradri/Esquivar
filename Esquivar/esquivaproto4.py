...
while True:
    ...
    tiempo_texto = fuente.render(f"Tiempo: {tiempo_partida / 1000:.3f} s", True, (0, 0, 0))
    pantalla.blit(tiempo_texto, (ancho_pantalla // 2 - 100, alto_pantalla - 50))

    # Dibujar "Has perdido" en el centro
    if vidas == 0:
        perdido_texto = fuente.render("Has perdido", True, (0, 0, 0))
        pantalla.blit(perdido_texto, (ancho_pantalla // 2 - 100, alto_pantalla // 2 - 20))
